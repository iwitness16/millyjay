            ...
            <div>
              ...
              <div className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="flex space-x-3 mt-4">
                  <a href="https://wa.me/15808007037" className="w-10 h-10 sm:w-12 sm:h-12 bg-green-500 rounded-lg flex items-center justify-center hover:bg-green-600 transition">
                  ...
                  <a href="https://t.me/jayID9" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500 rounded-lg flex items-center justify-center hover:bg-blue-600 transition">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
