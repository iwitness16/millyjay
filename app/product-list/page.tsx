...
const allProductsUnsorted: Product[] = [
  ...
  { id: 'alabama', name: 'Alabama', category: 'USA ID', price: 100, image: getProductFrontImage('Alabama') },
  { id: 'arizona', name: 'Arizona', category: 'USA ID', price: 100, image: getProductFrontImage('Arizona') },
  { id: 'california', name: 'California', category: 'USA ID', price: 100, image: getProductFrontImage('California') },
  { id: 'california-cm1', name: 'California CM1', category: 'USA ID', price: 100, image: getProductFrontImage('California CM1') },
  { id: 'connecticut', name: 'Connecticut', category: 'USA ID', price: 100, image: getProductFrontImage('Connecticut') },
  { id: 'delaware', name: 'Delaware', category: 'USA ID', price: 100, image: getProductFrontImage('Delaware') },
  { id: 'florida', name: 'Florida', category: 'USA ID', price: 100, image: getProductFrontImage('Florida') },
  { id: 'florida-motorcycle', name: 'Florida Motorcycle', category: 'USA ID', price: 100, image: getProductFrontImage('Florida Motorcycle') },
  { id: 'georgia', name: 'Georgia', category: 'USA ID', price: 100, image: getProductFrontImage('Georgia') },
  { id: 'illinois', name: 'Illinois', category: 'USA ID', price: 100, image: getProductFrontImage('Illinois') },
  { id: 'indiana', name: 'Indiana', category: 'USA ID', price: 100, image: getProductFrontImage('Indiana') },
  { id: 'kansas', name: 'Kansas', category: 'USA ID', price: 100, image: getProductFrontImage('Kansas') },
  { id: 'maryland', name: 'Maryland', category: 'USA ID', price: 100, image: getProductFrontImage('Maryland') },
  { id: 'massachusetts', name: 'Massachusetts', category: 'USA ID', price: 100, image: getProductFrontImage('Massachusetts') },
  { id: 'michigan', name: 'Michigan', category: 'USA ID', price: 100, image: getProductFrontImage('Michigan') },
  { id: 'minnesota', name: 'Minnesota', category: 'USA ID', price: 100, image: getProductFrontImage('Minnesota') },
  { id: 'mississippi', name: 'Mississippi', category: 'USA ID', price: 100, image: getProductFrontImage('Mississippi') },
  { id: 'missouri', name: 'Missouri', category: 'USA ID', price: 100, image: getProductFrontImage('Missouri') },
  { id: 'nebraska', name: 'Nebraska', category: 'USA ID', price: 100, image: getProductFrontImage('Nebraska') },
  { id: 'nevada', name: 'Nevada', category: 'USA ID', price: 100, image: getProductFrontImage('Nevada') },
  { id: 'new-jersey', name: 'New Jersey', category: 'USA ID', price: 100, image: getProductFrontImage('New Jersey') },
  { id: 'new-york', name: 'New York Old Verison', category: 'USA ID', price: 100, image: getProductFrontImage('New York Old Verison') },
  { id: 'north-carolina', name: 'North Carolina', category: 'USA ID', price: 100, image: getProductFrontImage('North Carolina') },
  { id: 'ohio', name: 'Ohio', category: 'USA ID', price: 100, image: getProductFrontImage('Ohio') },
  { id: 'pennsylvania', name: 'Pennsylvania', category: 'USA ID', price: 100, image: getProductFrontImage('Pennsylvania') },
  { id: 'rhode-island', name: 'Rhode Island', category: 'USA ID', price: 100, image: getProductFrontImage('Rhode Island') },
  { id: 'south-carolina', name: 'South Carolina', category: 'USA ID', price: 100, image: getProductFrontImage('South Carolina') },
  { id: 'texas', name: 'Texas', category: 'USA ID', price: 100, image: getProductFrontImage('Texas') },
  { id: 'utah', name: 'Utah', category: 'USA ID', price: 100, image: getProductFrontImage('Utah') },
  { id: 'virginia', name: 'Virginia', category: 'USA ID', price: 100, image: getProductFrontImage('Virginia') },
  { id: 'washington', name: 'Washington', category: 'USA ID', price: 100, image: getProductFrontImage('Washington') },
  
  // USA ID - CDL (Commercial Driver License)
  { id: 'california-cdl', name: 'California CDL', category: 'USA ID', price: 100, image: getProductFrontImage('California CDL') },
  { id: 'illinois-cdl', name: 'Illinois CDL', category: 'USA ID', price: 100, image: getProductFrontImage('Illinois CDL') },
  { id: 'new-york-cdl', name: 'New York CDL', category: 'USA ID', price: 100, image: getProductFrontImage('New York CDL') },
  { id: 'ohio-cdl', name: 'Ohio CDL', category: 'USA ID', price: 100, image: getProductFrontImage('Ohio CDL') },
  { id: 'pennsylvania-cdl', name: 'Pennsylvania CDL', category: 'USA ID', price: 100, image: getProductFrontImage('Pennsylvania CDL') },
  { id: 'texas-cdl', name: 'Texas CDL', category: 'USA ID', price: 100, image: getProductFrontImage('Texas CDL') },
  
  // CANADA ID
  { id: 'british-columbia', name: 'British Columbia', category: 'CANADA ID', price: 100, image: getProductFrontImage('British Columbia') },
  { id: 'ontario', name: 'Ontario', category: 'CANADA ID', price: 100, image: getProductFrontImage('Ontario') },
  { id: 'quebec', name: 'Quebec', category: 'CANADA ID', price: 100, image: getProductFrontImage('Quebec') },
  
  // UK ID (removed England)
  { id: 'london', name: 'London', category: 'UK ID', price: 80, image: getProductFrontImage('London') },
  { id: 'newcastle', name: 'Newcastle', category: 'UK ID', price: 80, image: getProductFrontImage('Newcastle') },
  { id: 'wales', name: 'Wales', category: 'UK ID', price: 80, image: getProductFrontImage('Wales') },
  { id: 'scotland', name: 'Scotland', category: 'UK ID', price: 80, image: getProductFrontImage('Scotland') },
  { id: 'northern-ireland', name: 'Northern Ireland', category: 'UK ID', price: 80, image: getProductFrontImage('Northern Ireland') },
  { id: 'birmingham', name: 'Birmingham', category: 'UK ID', price: 80, image: getProductFrontImage('Birmingham') },
  { id: 'manchester', name: 'Manchester', category: 'UK ID', price: 80, image: getProductFrontImage('Manchester') },
  { id: 'liverpool', name: 'Liverpool', category: 'UK ID', price: 80, image: getProductFrontImage('Liverpool') },
  { id: 'leeds', name: 'Leeds', category: 'UK ID', price: 80, image: getProductFrontImage('Leeds') },
  { id: 'bristol', name: 'Bristol', category: 'UK ID', price: 80, image: getProductFrontImage('Bristol') },
  
  // SSN
  { id: 'ssn', name: 'SSN', category: 'SSN', price: 100, image: getProductFrontImage('SSN') },
];
